...
async function grantAccessToEnglishKits(kitRecords) {
    console.log('\n================================================================================');
    console.log('🔑 GRANTING ACCESS TO ENGLISH KITS');
    console.log('================================================================================\n');
...
async function main() {
    try {
        console.log('================================================================================');
        console.log('📦 UPLOADING ENGLISH MASTERY KITS');
        console.log('================================================================================\n');
        ...
        console.log(`✅ Successfully uploaded: ${successful.length}/${ENGLISH_KITS.length} kits`);
